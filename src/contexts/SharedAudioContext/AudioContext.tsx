...
export const SharedAudioContext = createContext<{
...
export const SharedAudioProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <SharedAudioContext.Provider value={contextValue}>
      {children}
      <audio ref={audio} />
